...
<div class="wrap">
	...
	<h2><?php _e( 'Footer Mega Grid Columns - Features', 'footer-mega-grid-columns' ); ?></h2><br />
	...
	<table class="wpos-plugin-pricing-table">
		...
		<colgroup></colgroup>	
			...
			<tr>
				...
				<th>
					...
					<p><?php _e( '$0 USD', 'footer-mega-grid-columns' ); ?></p>
				</th>
				<th>
					<h2><?php _e( 'Premium', 'footer-mega-grid-columns' ); ?></h2>
					<p><?php echo sprintf( __( 'Gain access to <strong>Footer Mega Grid Columns</strong> included in <br /><strong>Essential Plugin Bundle', 'footer-mega-grid-columns' ) ); ?></p>
		...
		<tfoot>
			<tr>
				<th></th>
				<td></td>
				<td><p><?php echo sprintf( __( 'Gain access to <strong>Footer Mega Grid Columns</strong> included in <br /><strong>Essential Plugin Bundle', 'footer-mega-grid-columns' ) ); ?></p>
				<a href="https://www.wponlinesupport.com/pricing/?utm_source=WP&utm_medium=Footer-Mega-Grid&utm_campaign=Upgrade-PRO" class="wpos-button" target="_blank"><?php _e( 'View Pricing Options', 'footer-mega-grid-columns' ); ?></a></td>
			</tr>
		</tfoot>
	</table>
</div>